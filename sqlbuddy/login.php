...
$data_from_dakota = false;
/*
| -------------------------------------------------------------------
| changed by Lev F. Savranskiy for dakota-cms.com
| -------------------------------------------------------------------


$dakota_db_config = '/system/application/config/database.php';


if( file_exists( $_SERVER{'DOCUMENT_ROOT'} .$dakota_db_config))  {
require( $_SERVER{'DOCUMENT_ROOT'} .$dakota_db_config);

$adapter =  $db['default']['dbdriver'];
$host =     $db['default']['hostname'];
$user =     $db['default']['username'];
$pass =     $db['default']['password'];
$database = $db['default']['database'];

$data_from_dakota = true;
...
*/
    ...
    if ($_POST) {
        ...
        if (($adapter != "sqlite" && $host && $user && ($pass || $_POST || $data_from_dakota)) || ($adapter == "sqlite" && $database)) {
                    ...
                    if ($ua && $ie && $ieVer < 7) {
                        ...
                        ?>
                            <table cellpadding="0" id="tb">
                                <tr>
                                    <td class="loginheader"><h3><?php echo __("Unsupported browser"); ?></h3><a
                                            href="http://www.sqlbuddy.com/help/"
                                            title="Help"><?php echo __("Help!"); ?></a></td>
                                </tr>
                                <tr>
                                    <td><?php echo __("We're sorry, but  Internet Explorer 7 and more is supported. It is available as a free download on Microsoft's website. Other free browsers are also supported, including Firefox, Safari, and Opera."); ?></td>
                                </tr>
                            </table>
                        <?php
                        ...
                        ?>
                            <table cellpadding="0" id="tb">
                                <tr>
                                    <td colspan="2">
                                        <div class="loginheader"><h3><strong><?php echo __("Login"); ?></strong></h3><a
                                                href="http://www.sqlbuddy.com/help/"
                                                title="Help"><?php echo __("Help!"); ?></a></div>
                                    </td>
                                </tr>
                            <?php
                                        if (isset($error)) {
                            ...
                            <table cellpadding="0"
                                   id="REGOPTIONS"<?php if ($adapter == "sqlite") echo ' style="display: none"'; ?>>
                                <tr>
                            ...
                            <table cellpadding="0"
                                   id="LITEOPTIONS"<?php if ($adapter == "mysql") echo ' style="display: none"'; ?>>
                                <tr>
                                    <td class="field"><?php echo __("Database"); ?>:</td>
                                    <td><input type="text" class="text" name="DATABASE" id="DATABASE"
                            ...
                            <table cellpadding="0">
                                <tr>
                                    <td class="field"></td>
                                    <td><input type="submit" class="inputbutton" value="<?php echo __("Submit"); ?>"/>
                                    </td>
                                </tr>
                            </table>
                        <?php
