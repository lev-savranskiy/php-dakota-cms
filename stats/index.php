...
<center>&copy; <A HREF="http://adubus.free.fr/audistat/" target="_blank">AudiStat</A> v1.3</center>
...
if (isset($_GET['mday']) && is_numeric( $_GET['mday']) ) {$mday = $_GET['mday'];}
...
/*  echo 'z';
  echo isset($_GET['year']) && is_numeric( $_GET['year']);*/
