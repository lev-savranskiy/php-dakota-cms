...
<? if (Auth::has_role()) {
    ...
    switch ($result) {
        case 0:
            {
                $result_text =  lang('dakota_email_not_found');
                  break;
            }
        case 1:
            {
                $result_text =  lang('dakota_password_reset_success_text') . nbs(). $user->email  ;
                break;
            }
        case 3 :
            {
                $result_text = lang('dakota_password_reset_blocked');
                break;
            }
        default:
            {
